// 生成 src/data/audits.ts：以 114 题真实 id 为基础，标记 5 条 flagged + 其余 passed。
...
const FLAGS = {
  ...
  "me-020": "reference author list is garbled (duplicated 'Gérard-Varet' entries); citation must be repaired before display",
};
