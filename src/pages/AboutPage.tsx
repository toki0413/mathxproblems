...
const C = {
  zh: {
    ...
    disclosure: [
      ...
      ['审计展示门', '2026-09-02 起对全部 114 条执行逐题一致性审计（陈述精确性 / 收录标准 / 状态时效 / 文献支撑 / 评级合理，kind=ai-assisted，非专家复核）。首轮揪出 5 处问题，已逐条修复并核实文献，当前 114 条全部通过、全部公开展示。修复记录与原因保留在审计表（src/data/audits.ts）供任何人复核。',],
  ...
  en: {
    ...
    disclosure: [
      ...
      ['Audit display gate', 'Since 2026-09-02 every entry is subject to a per-problem consistency audit (statement precision / inclusion criterion / status timeliness / reference support / rating soundness; kind=ai-assisted, not expert review). The first pass flagged 5 issues; each was repaired and its literature re-verified, and all 114 entries now pass the gate and are publicly displayed. Fix records and reasons remain on the audit record (src/data/audits.ts) for anyone to re-check.'],
